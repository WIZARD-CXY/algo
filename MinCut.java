...
class AdjacencyLists {
        ...
        public void contractVertex(int nodeA, int nodeB) {
                deleteEdge(nodeA, nodeB); // delete the edge nodeB in nodeA nodeEdge and delete the edge related nodeA in nodeB noeEdge
                findEnd(nodeA, nodeB); // change nodeB to a in node change
                addList(nodeA, nodeB); // add nodeB 's edge node in the last of nodeA
...
//                        print(nodeB);
        ...
        public void changeToEnd(int nodeA, int nodeB, int change) { //adjust the other node to connect to the super node named nodeA
        ...
        public void addList(int nodeA, int nodeB) {
                while (!nodeHash.get(nodeB).nodeEdge.isEmpty()) {
                        int vertex = nodeHash.get(nodeB).nodeEdge.pop();
                        //if(!nodeHash.get(nodeA).nodeEdge.contains(vertex))
                       // {
                             nodeHash.get(nodeA).nodeEdge.addLast(vertex);
                       // }
                }
                //print(nodeA);
        }
...
public class MinCut {
        ...
        public void input() {
                ...
                try {
                        String file = "/home/wizard/kargerMinCut.txt";
        ...
        public void randEdge() {
                ...
                indexOfNodeB = rand.nextInt(randomSeed); // from 0 to nodeA.nodeEdge.size()
